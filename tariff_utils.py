...
tariff_utils.py
---------------
Time-based tariff period detection and rate window calculations.

Provides helper functions for determining cheap-rate windows, tariff periods,
hours until rate changes, and dividing solar days into scheduling periods.
"""
